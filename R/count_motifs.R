...
#' @param lvl_attr character vector specifying the attribute name where level information
#' is stored in statnet object.
...
#'   list("1,2[I.C]")
#' @param lvl_attr character vector specifying the vertex attribute name where level

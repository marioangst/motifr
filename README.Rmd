...
motifr provides a reliable starting point for multi-level network visualization but is focused on motif analyis at its core. For advanced visualization of multi-level networks we recommend pairing [ggraph](https://cran.r-project.org/web/packages/ggraph/index.html) and [graphlayouts](https://cran.r-project.org/web/packages/graphlayouts/index.html). [This blog post](http://blog.schochastics.net/post/visualizing-multilevel-networks-with-graphlayouts/) provides an excellent introduction.

...
Package features include:
  ...
  motifr further identifies and visualizes functional gaps and critical edges in multi-level networks based on contributions of existing or potential edges to given motifs (this is theoretically based on network theories of functional fit and misfit).

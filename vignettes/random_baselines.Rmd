...
to specify different probabilites ties occurring _within_ different levels.
...
```{r}
motifs_distribution(ml_net, motifs = list("2,1[II.C]"), model = "actors_choice")
```
...
```{r}
motifs_distribution(ml_net, motifs = list("2,2[I.A]", "2,2[I.B]", "2,2[I.C]", "2,2[I.D]"), model = "actors_choice")
motifs_distribution(ml_net, motifs = list("2,2[I.A]", "2,2[I.B]", "2,2[I.C]", "2,2[I.D]"), model = "actors_choice", level = 1)
```
...
```{r  out.width="300px"}
show_motif("2,2[I.A]", net = ml_net, label = TRUE)
show_motif("2,2[I.B]", net = ml_net, label = TRUE)
show_motif("2,2[I.C]", net = ml_net, label = TRUE)
```
...
compare_to_baseline(dummy_net, list('1,2[I.A]', '1,2[I.C]', '1,2[II.C]'), n = 50, model = "ergm", ergm_model = model)
compare_to_baseline(dummy_net, list('1,2[I.A]', '1,2[I.C]', '1,2[II.C]'), n = 50, model = "erdos_renyi")
```
